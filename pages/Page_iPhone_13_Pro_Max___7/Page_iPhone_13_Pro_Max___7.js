...
import {image_Rectangle_46_link} from './assets/imageLinks.js'
import {image_Rectangle_36_3_link} from './assets/imageLinks.js'
import {image_Rectangle_36_4_link} from './assets/imageLinks.js'
const Page_iPhone_13_Pro_Max___7  = ({navigation}) => {
	useEffect(() => {
	}, []);
	return (
	...
	<ScrollView bounces={false} showsVerticalScrollIndicator={false} style={{height: Dimensions.get("window").height}}>
		<View style = {noneModeStyles._page3}    >
			...
			<Text style = {noneModeStyles._Training_Plan}   >
				Training Plan
			</Text>
			<View style = {noneModeStyles._Rectangle_46_container}    >
				<View style = {noneModeStyles._Rectangle_46}   >
					<Image style={{height: "100%", width: "100%"}} source = {{uri: image_Rectangle_46_link}}/>
				</View>
			</View>
			<View style = {noneModeStyles._Rectangle_36_2}    >
			</View>
			<View style = {noneModeStyles._Rectangle_36_container}    >
				<View style = {noneModeStyles._Rectangle_36_3}   >
					<Image style={{height: "100%", width: "100%"}} source = {{uri: image_Rectangle_36_3_link}}/>
				</View>
			</View>
			<View style = {noneModeStyles._Rectangle_36_container_2}    >
				<View style = {noneModeStyles._Rectangle_36_4}   >
					<Image style={{height: "100%", width: "100%"}} source = {{uri: image_Rectangle_36_4_link}}/>
				</View>
			</View>
			<View style = {noneModeStyles._Group_1320}    >
			...
			<View style = {noneModeStyles._Group_1320_2}    >
			...
			<Text style = {noneModeStyles._Plan}   >
				Plan
			</Text>
			...
			<Text style = {noneModeStyles._Make_Plan}   >
				Make Plan
			</Text>
			<Text style = {noneModeStyles._Make_Plan_2}   >
				Make Plan
			</Text>
			<Text style = {noneModeStyles._Make_Plan_3}   >
				Make Plan
			</Text>
			<Text style = {noneModeStyles._Make_Plan_4}   >
				Make Plan
			</Text>
		</View>
	</ScrollView>
...
export default Page_iPhone_13_Pro_Max___7
