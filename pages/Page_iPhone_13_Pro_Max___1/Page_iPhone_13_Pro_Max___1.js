			...
			<View style = {noneModeStyles._viewport}    >
				<View style = {noneModeStyles._Frame_1}    >
					...
					<View style = {noneModeStyles._SWM_icons___outline___speaker_2}    >
						<View style = {noneModeStyles._layer_34a0a1}    >
							<View style = {noneModeStyles._layer_b2cf64}   >
					...
					<View style = {noneModeStyles._battery_charging}    >
						<View style = {noneModeStyles._layer_7958e4}    >
							<View style = {noneModeStyles._layer_94e993}   >
					...
					<View style = {noneModeStyles._bar_chart}    >
						<View style = {noneModeStyles._layer_917e71}    >
							<View style = {noneModeStyles._layer_bd3fb6}   >
					...
					<View style = {noneModeStyles._bar_chart_2}    >
						<View style = {noneModeStyles._layer_18a71c}    >
							<View style = {noneModeStyles._layer_dbeeab}   >
								<Svg style={{height: 19, width: 19}} viewBox = "0 0 19 19">
									<Path fill = {"white"} fillRule = {"evenodd"} clipRule = {"evenodd"}   d = "M1.26667 19H18.3667C18.5346 19 18.6957 18.9333 18.8145 18.8145C18.9333 18.6957 19 18.5346 19 18.3667C19 18.1987 18.9333 18.0376 18.8145 17.9188C18.6957 17.8001 18.5346 17.7333 18.3667 17.7333H1.26667V0.633333C1.26667 0.465363 1.19994 0.304272 1.08117 0.185499C0.962395 0.066726 0.801304 0 0.633333 0C0.465363 0 0.304272 0.066726 0.185499 0.185499C0.066726 0.304272 0 0.465363 0 0.633333V17.7333C0 18.0693 0.133452 18.3915 0.370998 18.629C0.608544 18.8665 0.930726 19 1.26667 19ZM3.95833 16.4667H5.54167C5.9196 16.4667 6.28205 16.3165 6.54929 16.0493C6.81653 15.7821 6.96667 15.4196 6.96667 15.0417V9.025C6.96667 8.64707 6.81653 8.28461 6.54929 8.01737C6.28205 7.75013 5.9196 7.6 5.54167 7.6H3.95833C3.5804 7.6 3.21795 7.75013 2.95071 8.01737C2.68347 8.28461 2.53333 8.64707 2.53333 9.025V15.0417C2.53333 15.4196 2.68347 15.7821 2.95071 16.0493C3.21795 16.3165 3.5804 16.4667 3.95833 16.4667ZM11.2417 16.4667H9.65833C9.2804 16.4667 8.91795 16.3165 8.65071 16.0493C8.38347 15.7821 8.23333 15.4196 8.23333 15.0417V7.125C8.23333 6.74707 8.38347 6.38461 8.65071 6.11737C8.91795 5.85013 9.2804 5.7 9.65833 5.7H11.2417C11.6196 5.7 11.9821 5.85013 12.2493 6.11737C12.5165 6.38461 12.6667 6.74707 12.6667 7.125V15.0417C12.6667 15.4196 12.5165 15.7821 12.2493 16.0493C11.9821 16.3165 11.6196 16.4667 11.2417 16.4667ZM15.3441 16.4667H16.9274C17.3054 16.4667 17.6678 16.3165 17.9351 16.0493C18.2023 15.7821 18.3524 15.4196 18.3524 15.0417V4.59167C18.3524 4.21373 18.2023 3.85128 17.9351 3.58404C17.6678 3.3168 17.3054 3.16667 16.9274 3.16667H15.3441C14.9662 3.16667 14.6037 3.3168 14.3365 3.58404C14.0692 3.85128 13.9191 4.21373 13.9191 4.59167V15.0417C13.9191 15.4196 14.0692 15.7821 14.3365 16.0493C14.6037 16.3165 14.9662 16.4667 15.3441 16.4667Z"/>
								</Svg>
							</View>
				...
				<Text style = {noneModeStyles._HERE}   >
					HERE
				</Text>
				<View style = {noneModeStyles._Rectangle_1}    >
				</View>
				<Text style = {noneModeStyles._Email_Id}   >
					Email Id
				</Text>
				<View style = {noneModeStyles._Rectangle_2}    >
				</View>
				<View style = {noneModeStyles._Solid_Status_Key}    >
					<View style = {noneModeStyles._layer_aece71}    >
						<View style = {noneModeStyles._layer_d15c59}   >
							<Svg style={{height: 15, width: 27}} viewBox = "0 0 27 15">
								<Path fill = {"white"} fillRule = {"evenodd"} clipRule = {"evenodd"}   d = "M0.0100343 7.57855C-0.198119 3.60674 2.85293 0.218208 6.82474 0.0100547C9.55201 -0.132876 12.0025 1.26087 13.3385 3.43113L24.5314 2.84453C25.7402 2.78118 26.7715 3.70976 26.8348 4.91857L26.9987 8.04536C27.0258 8.56342 26.6279 9.0054 26.1098 9.03255L23.2957 9.18003L23.4104 11.3688C23.4376 11.8868 23.0396 12.3288 22.5215 12.356L19.3948 12.5198C18.8767 12.547 18.4347 12.149 18.4076 11.631L18.2929 9.44222L13.969 9.66882C13.0088 12.2987 10.5528 14.2374 7.57853 14.3933C3.60672 14.6014 0.218188 11.5504 0.0100343 7.57855ZM7.07054 4.70023C5.68904 4.77263 4.62781 5.95125 4.70021 7.33275C4.77261 8.71425 5.95123 9.77548 7.33273 9.70308C8.71423 9.63068 9.77546 8.45206 9.70306 7.07056C9.63066 5.68906 8.45204 4.62783 7.07054 4.70023Z"/>
								<Path fill = {"white"} fillRule = {"evenodd"} clipRule = {"evenodd"}   d = "M0.0100343 7.57855C-0.198119 3.60674 2.85293 0.218208 6.82474 0.0100547C9.55201 -0.132876 12.0025 1.26087 13.3385 3.43113L24.5314 2.84453C25.7402 2.78118 26.7715 3.70976 26.8348 4.91857L26.9987 8.04536C27.0258 8.56342 26.6279 9.0054 26.1098 9.03255L23.2957 9.18003L23.4104 11.3688C23.4376 11.8868 23.0396 12.3288 22.5215 12.356L19.3948 12.5198C18.8767 12.547 18.4347 12.149 18.4076 11.631L18.2929 9.44222L13.969 9.66882C13.0088 12.2987 10.5528 14.2374 7.57853 14.3933C3.60672 14.6014 0.218188 11.5504 0.0100343 7.57855ZM7.07054 4.70023C5.68904 4.77263 4.62781 5.95125 4.70021 7.33275C4.77261 8.71425 5.95123 9.77548 7.33273 9.70308C8.71423 9.63068 9.77546 8.45206 9.70306 7.07056C9.63066 5.68906 8.45204 4.62783 7.07054 4.70023Z"/>
							</Svg>
						</View>
					</View>
				...
				<View style = {noneModeStyles._SWM_icons___outline___mail}    >
					<View style = {noneModeStyles._layer_498277}    >
						<View style = {noneModeStyles._layer_ad0448}   >
							<Svg style={{height: 19, width: 24}} viewBox = "0 0 24 19">
								<Path fill = {"none"}   stroke = {"#E5E5E5"} strokeWidth = {1.5} d = "M1.375 1.375L10.2322 10.2322C11.2085 11.2085 12.7915 11.2085 13.7678 10.2322L22.625 1.375M2 18.25H22C22.6904 18.25 23.25 17.6904 23.25 17V2C23.25 1.30964 22.6904 0.75 22 0.75H2C1.30964 0.75 0.75 1.30964 0.75 2V17C0.75 17.6904 1.30964 18.25 2 18.25Z"/>
							</Svg>
						</View>
					</View>
				</View>
				<Text style = {noneModeStyles._Register_now}   >
					Register now
				</Text>
				<View style = {noneModeStyles._Group_1311}    >
					<View style = {noneModeStyles._Wifi___24___Outline}    >
						<View style = {noneModeStyles._layer_351649}    >
							<View style = {noneModeStyles._layer_835a75}   >
